...
The R function [`fokus:::gen_q_tibble()`](https://rpkg.dev/fokus/reference/gen_q_tibble.html), which is designed to turn the raw questionnaire into a
...
```{r, echo = FALSE}
fs::path_package("asciicasts/gen_q_tibble-success.json",
                 package = "fokus") %>%
  asciicast::read_cast() %>%
...
output would stop immediately, allowing to easily locate the source position of the mistake.

...
-   You can even cross-reference keys from non-parent nodes using [`qstnr_item_val()`](https://rpkg.dev/fokus/reference/qstnr_item_val.html). But be careful to
...
The R function [`fokus:::gen_qstnr_tibble()`](https://rpkg.dev/fokus/reference/gen_qstnr_tibble.html), which is designed to turn the raw questionnaire into a

...
Expands questionnaire tibble to [long format](https://en.wikipedia.org/wiki/Wide_and_narrow_data).
...
-   Removes all Markdown formatting from character columns of a questionnaire tibble.
-   Replaces placeholder values in multi-value columns with NA.

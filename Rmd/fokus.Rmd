...
#'
#' Reads in the FOKUS survey data generated by [export_survey_data()] for the specified ballot date in the specified canton and the specified language.
#'
#' @inheritParams ballot_title
#'
#' @return `r pkgsnip::return_lbl("tibble")`
...
read_survey_data <- function(ballot_date = pal::pkg_config_val(key = "ballot_date",
  ...
  read_private_file(path = glue::glue("generated/survey_data_{lang}_{ballot_date}_{canton}.rds"),
                    as_chr = FALSE) |>
    memDecompress() |>
    unserialize()
}

...
#### `check_devisable_map_completeness`
...
-   although they are saved as "internal data" in `R/sysdata.rda`, they are still exported later on, something [not explicitly
...
TODO: Explain concept of truth anchors!
...
TODO: Explain fundamental predicates!
...
TODO: Explain higher predicates!
...
-   Think about implementing a fn that returns the wd structure *as structured data*, i.e. a properly nested list of paths or the like. Then this print fn could
    be replaced by a to-text-converter of the new fn.

...
Predicate functions based on the [metadata](#section-fokus-metadata) and the [raw questionnaire data](raw_qstnr.html).
...
Functions to export data necessary to conduct a FOKUS survey.

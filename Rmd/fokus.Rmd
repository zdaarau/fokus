...
-   This is a temporary replacement for the [broken `gitlabr::gl_push_file()`](https://github.com/ThinkR-open/gitlabr/issues/111#issuecomment-1897728438) until
    gitlabr \> 2.0.1 is released which includes [ThinkR-open/gitlabr#106](https://github.com/ThinkR-open/gitlabr/pull/106).
...
-   Remove `utils::URLencode()` once gitlabr \> 2.0.1 is released which includes [ThinkR-open/gitlabr#106](https://github.com/ThinkR-open/gitlabr/pull/106).
...
-   Replace `push_private_file()` with `gitlabr::gl_push_file()` once gitlabr \> 2.0.1 is released which includes
    [ThinkR-open/gitlabr#106](https://github.com/ThinkR-open/gitlabr/pull/106).

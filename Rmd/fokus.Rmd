...
#'
#' Returns a list containing the ballot types that have been covered by the FOKUS survey for the specified canton at the specified ballot date on the specified
#' political level(s).
#'
#' @inheritParams ballot_types
#'
#' @return A list with an element per ballot type.
#' @family predicate_fundamental
#' @export
#'
#' @examples
    ...
    purrr::map(\(lvl) {
      ...
      proposal_nrs(ballot_date = ballot_date,
        ...
        purrr::map(\(proposal_nr) {
          ...
          } else if (has_proposal_arguments(ballot_date = ballot_date,
                                            lvl = lvl,
                                            canton = canton,
                                            proposal_nr = proposal_nr)) {
            result <- list(lvl = lvl,

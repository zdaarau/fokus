...
Functions to process the [raw FOKUS questionnaire data](raw_qstnr.html) and other functions to conduct a survey.
...
#'
#' Transforms a [proposal argument][proposal_arguments] side into a full prose string representation.
#'
#' @inheritParams proposal_argument
#'
#' @return A character scalar.
...
#'
#' Transforms a [proposal main motives][proposal_main_motives] type into a full prose string representation.
#'
#' @inheritParams proposal_main_motives
#' @inheritParams lang_to_locale
#'
...
### `proposal_name_declined_de`

TODO:

-   Improve the underlying `salim::decline_noun_de()` fn. Cases where it currently fails include:

    -   `fokus::proposal_name_declined_de(ballot_date = "2023-06-18", proposal_nr = 2, lvl = "federal", type = "long", case = "dative")`

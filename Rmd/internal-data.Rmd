...
ballot_metadata <-
  ...
  purrr::map_dfr(function(raw_q_suppl) {
    ...
    tibble::tibble(ballot_date = raw_q_suppl$ballot_date,
                   canton = unique(names(raw_q_suppl$mode))) %>%
...
q_item_keys <- tibble::tribble(
  ...
  ~key,                         ~is_scalar, ~is_iterator, ~is_excluder, ~type,
  "lvl",                        FALSE,      TRUE,         FALSE,        "character",
  "i",                          FALSE,      TRUE,         FALSE,        "character",
  "j",                          FALSE,      TRUE,         FALSE,        "character",
  "block",                      TRUE,       FALSE,        FALSE,        "character",
  "variable_name",              TRUE,       FALSE,        FALSE,        "character",
  "who",                        TRUE,       FALSE,        FALSE,        "character",
  "topic",                      TRUE,       FALSE,        FALSE,        "character",
  "question",                   TRUE,       FALSE,        FALSE,        "character",
  "question_common",            TRUE,       FALSE,        FALSE,        "character",
  "variable_label",             TRUE,       FALSE,        FALSE,        "character",
  "variable_label_common",      TRUE,       FALSE,        FALSE,        "character",
  "response_options",           FALSE,      FALSE,        FALSE,        "character",
  "variable_values",            FALSE,      FALSE,        FALSE,        "integer",
  "value_labels",               FALSE,      FALSE,        FALSE,        "character",
  "value_scale",                TRUE,       FALSE,        FALSE,        "character",
  "multiple_answers_allowed",   TRUE,       FALSE,        FALSE,        "logical",
  "randomize_response_options", TRUE,       FALSE,        FALSE,        "logical",
  "ballot_types",               FALSE,      FALSE,        TRUE,         "character",
  "include",                    TRUE,       FALSE,        TRUE,         "logical"
)
```

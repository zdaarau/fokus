...
q_item_keys <- tibble::tribble(
  ...
  "question_full",              TRUE,       FALSE,        FALSE,        TRUE,         "character", NA_character_, paste0("alternative fully formulated version",
                                                                                                                         ...
                                                                                                                         "`question`"),
  "question_intro_i",           TRUE,       FALSE,        FALSE,        TRUE,         "character", NA_character_, "1st-priority part of \"Frage\"",
  "question_intro_j",           TRUE,       FALSE,        FALSE,        TRUE,         "character", NA_character_, "2nd-priority part of \"Frage\"",
